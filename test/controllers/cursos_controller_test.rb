...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { descripcion: @curso.descripcion, fch_fin: @curso.fch_fin, fch_ini: @curso.fch_ini, nombre: @curso.nombre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { descripcion: @curso.descripcion, fch_fin: @curso.fch_fin, fch_ini: @curso.fch_ini, nombre: @curso.nombre }
    assert_redirected_to curso_path(assigns(:curso))
  end
