...
class InstitucionsControllerTest < ActionController::TestCase
  ...
  test "should create institucion" do
    assert_difference('Institucion.count') do
      post :create, institucion: { cod: @institucion.cod, direccion: @institucion.direccion, email: @institucion.email, nombre: @institucion.nombre, telefono: @institucion.telefono }
    end
  ...
  test "should update institucion" do
    patch :update, id: @institucion, institucion: { cod: @institucion.cod, direccion: @institucion.direccion, email: @institucion.email, nombre: @institucion.nombre, telefono: @institucion.telefono }
    assert_redirected_to institucion_path(assigns(:institucion))
  end
