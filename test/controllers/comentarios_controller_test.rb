...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { asunto: @comentario.asunto, mail: @comentario.mail, mensaje: @comentario.mensaje, nombre: @comentario.nombre }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { asunto: @comentario.asunto, mail: @comentario.mail, mensaje: @comentario.mensaje, nombre: @comentario.nombre }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
