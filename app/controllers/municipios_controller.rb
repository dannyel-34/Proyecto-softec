class MunicipiosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @municipio.save
        format.html { redirect_to @municipio, notice: 'Municipio se ha creado correctamente.' }
  ...
  def update
    respond_to do |format|
      if @municipio.update(municipio_params)
        format.html { redirect_to @municipio, notice: 'Municipio se ha actualizado correctamente.' }
  ...
  def destroy
    @municipio.destroy
    respond_to do |format|
      format.html { redirect_to municipios_url, notice: 'Municipio se ha eliminado correctamente.' }
